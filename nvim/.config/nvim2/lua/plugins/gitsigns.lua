    ...
    require("gitsigns").setup {
      ...
      on_attach = function(bufnr)
        ...
        map("n", "<leader>hD", function()
          gitsigns.diffthis "~"
        end, { desc = "Show diff of the revision" })

        map("n", "<leader>hQ", function()
          gitsigns.setqflist "all"
        end, { desc = "Quick fix with all the hunk" })
        map("n", "<leader>hq", gitsigns.setqflist, { desc = "Quick fix with the current buffer" })
        ...
        -- Text object
        map({ "o", "x" }, "ih", gitsigns.select_hunk, { desc = "select hunk in motion" })
      end,
    }
  end,
}
